...
void Tutorial02_Cube::CreateVertexBuffer()
{
    ...
    constexpr Vertex CubeVerts[24] =
    {
            ...
            {float3(-3, -1, -1), float4(1, 0, 0, 1)},
            {float3(-3, +1, -1), float4(0, 1, 0, 1)},
            {float3(+3, +1, -1), float4(0, 0, 1, 1)},

            {float3(-2, -2, +1), float4(1, 1, 0, 1)},
            {float3(-2, +2, +1), float4(0, 1, 1, 1)},
            {float3(+2, +2, +1), float4(1, 0, 1, 1)},

            {float3(-4, +1, +1), float4(0, 1, 1, 1)},
            {float3(+3, +2, +1), float4(1, 0, 1, 1)},
            {float3(-5, +3, +1), float4(0, 1, 1, 1)},

            {float3(+2, +4, +1), float4(1, 0, 1, 1)},
            {float3(-8, +2, +1), float4(0, 1, 1, 1)},
            {float3(+5, +1, +1), float4(1, 0, 1, 1)},

            {float3(-3, +2, +1), float4(0, 1, 1, 1)},
            {float3(+3, +2, +1), float4(1, 0, 1, 1)},
            {float3(-4, +1, +1), float4(0, 1, 1, 1)},
            
            {float3(-3, +2, +1), float4(1, 0, 1, 1)},
            {float3(-9, +2, +1), float4(0, 1, 1, 1)},
            {float3(+2, +3, +1), float4(1, 0, 1, 1)},

            {float3(-6, +1, +1), float4(0, 1, 1, 1)},
            {float3(+1, +2, +1), float4(1, 0, 1, 1)},
            {float3(+6, -2, +1), float4(0.2f, 0.2f, 0.2f, 1)},
